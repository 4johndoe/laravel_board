...
class AttributeController extends Controller
{
    ...
    public function store(Request $request, Category $category)
    {
        ...
        return redirect()
            ->route('admin.adverts.categories.attributes.show', [$category, $attribute]);
    }
    ...
    public function update(Request $request, Category $category, Attribute $attribute)
    {
        ...
        return redirect()
            ->route('admin.adverts.categories.attributes.show', $category);
    }
    ...
    public function destroy(Category $category, Attribute $attribute)
    {
        ...
        return redirect()->route('admin.adverts.categories.attributes.index');
    }
}
